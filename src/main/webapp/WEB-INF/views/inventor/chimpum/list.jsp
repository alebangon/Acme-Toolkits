...
<acme:list> 
	...
	<acme:list-column code="inventor.chimpum.list.label.start_date" path="startDate"/>	 
	<acme:list-column code="inventor.chimpum.list.label.end_date" path="endDate"/>
	<acme:list-column code="inventor.chimpum.list.label.creationMoment" path="creationMoment"/>
</acme:list>  
<acme:button code="inventor.chimpum.list.button.create-chimpum" action="/inventor/chimpum/create"/>